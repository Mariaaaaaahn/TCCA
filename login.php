...
<section class="account-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p class="placeholder">Insira seu email <span>*</span></p>
      <input type="email" name="email" required maxlength="50" placeholder="coloque seu email" class="box">
      <p class="placeholder">insira sua senha <span>*</span></p>
      <input type="password" name="pass" required maxlength="50" placeholder="coloque sua senha" class="box">
      <p class="link">Não tem conta?? <a href="register.php">Registre-se</a></p>
