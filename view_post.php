...
<section class="view-post">
   ...
   <div class="heading"><h1>Detalhes da postagem</h1> <a href="all_posts.php" class="inline-option-btn" style="margin-top: 0;">all posts</a></div>
...
<section class="reviews-container">
   ...
   <div class="heading"><h1>Comentários</h1> <a href="add_review.php?get_id=<?= $get_id; ?>" class="inline-btn" style="margin-top: 0;">add review</a></div>
   ...
   <?php
         ...
         echo '<p class="empty">Não há comentarios!</p>';
      }
   ?>
